...
- **手动扫描**：一键扫描全项目并更新索引
- **已索引资源浏览**：在配置面板底部查看所有已索引资源列表，支持按路径/描述搜索、按状态过滤、缩略图预览
- **选择性重新索引**：勾选资源后点击 Re-index 按钮，仅重新处理选中的资源
...
7. 展开 **Indexed Assets** 查看所有已索引资源，可按路径/描述搜索、按状态筛选
8. 勾选需要重新索引的资源，点击 **Re-index Selected** 重新生成描述和向量
